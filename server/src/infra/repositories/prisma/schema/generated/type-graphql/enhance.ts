...
const outputsInfo = {
  ...
  CategoryGroupBy: ["id", "name", "description", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  CategoryCountAggregate: ["id", "name", "description", "_all"],
  CategoryAvgAggregate: ["id"],
  CategorySumAggregate: ["id"],
  CategoryMinAggregate: ["id", "name", "description"],
  CategoryMaxAggregate: ["id", "name", "description"]
};
...
const inputsInfo = {
  CategoryWhereInput: ["AND", "OR", "NOT", "id", "name", "description"],
  CategoryOrderByWithRelationInput: ["id", "name", "description"],
  CategoryWhereUniqueInput: ["id"],
  CategoryOrderByWithAggregationInput: ["id", "name", "description", "_count", "_avg", "_max", "_min", "_sum"],
  CategoryScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "description"],
  CategoryCreateInput: ["name", "description"],
  CategoryUpdateInput: ["name", "description"],
  CategoryCreateManyInput: ["id", "name", "description"],
  CategoryUpdateManyMutationInput: ["name", "description"],
  IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  StringFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "mode", "not"],
  CategoryCountOrderByAggregateInput: ["id", "name", "description"],
  CategoryAvgOrderByAggregateInput: ["id"],
  CategoryMaxOrderByAggregateInput: ["id", "name", "description"],
  CategoryMinOrderByAggregateInput: ["id", "name", "description"],
